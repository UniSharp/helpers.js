...
var METHODS = ['keys', 'values', 'contains', 'count', 'has', 'get', 'sum', 'avg', 'each', 'slice', 'reduce', 'toArray', 'chunk', 'filter', 'isEmpty', 'isNotEmpty', 'first', 'last', 'map', 'flatten', 'min', 'max', 'unique'];